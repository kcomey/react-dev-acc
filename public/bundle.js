  ...
  render: function(){
    return (
        React.createElement("div", null, 
          React.createElement("input", {type: "text", value: this.state.note, onChange: this.updateNewNote}), 
          React.createElement("button", {onClick: this.handleAddNew}, " Add Note ")
        )
    );
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        ...
        React.createElement(NoteContainer, {url: this.props.url})
      )
    )
  }
})
...
},{"./header":3,"./noteContainer":4,"react":161}],3:[function(require,module,exports){
var React = require('react')

var Header = React.createClass({displayName: "Header",
  render: function() {
    return (
    React.createElement("h2", null, "Kendall's Note App")
    )
  }
})
...
var NoteContainer = React.createClass({displayName: "NoteContainer",
    ...
    render: function(){
      return (
        React.createElement("div", null, 
          React.createElement(AddNote, {notes: this.state.notes, addNote: this.handleNoteSubmit}), 
          React.createElement(NoteList, {notes: this.state.notes, handleDelete: this.handleDelete})
        )
      )
    }
});
...
},{"./addNote":1,"./noteList":5,"react":161}],5:[function(require,module,exports){
var React = require('react')
    ...
    var listNotes = this.props.notes.map(function(note, index){
      return (
        React.createElement("li", null, 
          ...
          "[", React.createElement("a", {href: "#", onClick: this.props.handleDelete.bind(this, note, index)}, "x"), "]"
        )
      )
    }.bind(this));
    return (
